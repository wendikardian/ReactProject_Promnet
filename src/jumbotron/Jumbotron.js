    ...
    <>
        ...
        <section className="jumbotron" >
            <div className="text-jumbotron">
                ...
                <p data-aos="fade-up">Hello There Wanna See Who I am, u can scroll it below. I'm a Collage Student from Universitas Pendidikan Indonesia Majoring in <span className="pink"> Computer Science Education</span></p> 
